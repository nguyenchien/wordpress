...
class bcn_breadcrumb_trail
{
	...
	protected function post_hierarchy($id, $type, $parent = null)
	{
		...
		if(isset($this->opt['bpost_' . $type . '_hierarchy_display']) && $this->opt['bpost_' . $type . '_hierarchy_display'])
		{
	...
	protected function type_archive($type, $type_str = false)
	{
		...
		if(isset($this->opt['bpost_' . $type_str . '_archive_display']) && $type_str && !$this->is_builtin($type_str) && $this->opt['bpost_' . $type_str . '_archive_display'] && $this->has_archive($type_str))
		{
			//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
	...
	public function fill()
	{
		...
		else if(is_singular())
		{
			...
			if (isset($this->opt['apost_' . $type->post_type . '_root'])) {
